...
\begin{izrek}[Prvi Hagov izrek]
    Zgornjo stranico $AB$ kvadrata $ABCD$ razpolovimo v točki $E$ in s pregibom nanjo položimo oglišče $C$. S tem na levi in desni stranici kvadrata dobimo tri točke, ki jih označimo z $F, G$ in $H$ (slika~\ref{fig:hagov_izrek1}). Za te točke velja:
    \begin{itemize}
...
Kot prej tudi tu dobimo tri podobne pravokotne trikotnike. Za vsak $i \in \{1,\ldots,6\}$ poiščimo sedaj vrednost $y_i$ v odvisnosti od $x$. Iz Pitagorovega izreka za pravokotni trikotnik $\triangle EDF$ sledi
$$y_1 = (1-x^2)/2,$$
