...
Konstrukcije poljubnega trikotnika, pravokotnika in kvadrata so zelo enostavne. Malo več premisleka pa je potrebnega za konstrukcije pravilnih $n$-kotnikov. Iz razdelka~\ref{podpogl:n_kotniki} vemo, da je edini pravilni $n$-kotnik, kjer je $n \leq 20$ in se ga ne da konstruirati z origamijem, $11$-kotnik. Postopkov za kosntrukcije ostalih večkotnikov je več. Johnson se na primer v nadaljevanju iste knjige posveti konstrukciji preko večkratnega zvijanja traku, kar pa krši pravilo o enkratnih prepogibih papirja.
...
Najmanjši pravilni večkotnik, ki ga ne moremo konstruirati z evklidskim orodjem, lahko pa ga z origamijem, je sedemkotnik. Hull v~\cite[str.\ 19--22]{hull2020} navaja potek njegove konstrukcije in tudi dokaže, da je rezultat res pravilni sedemkotnik. Ker pa postopek vključuje večkratne pregibe, ki so v tej nalogi prepovedani (večkratni pregibi odprejo veliko dodatnega prostora za raziskovanje matematike z origamijem, vendar je tema preobširna za vključitev v to nalogo), se s tem tu ne bomo ukvarjali.
...
\begin{figure}[h]
    ...
    \caption[Drugi Hagov izrek v številkah]{Razdalje po drugem Hagovem izreku. Vzeto in preurejeno iz~\cite[str. 15]{haga2008}.}
...
\begin{figure}[h]
    ...
    \caption[Primeri $X$-pregibov]{Primeri $X$-prepogibov in njihova unija. Vzeto in predelano iz~\cite[str.\ 36]{haga2008}.}
