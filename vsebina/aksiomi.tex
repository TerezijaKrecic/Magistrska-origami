...
\begin{dokaz}
    ...
    \begin{enumerate}
        ...
        \item Daljico $A'B''$ rotiramo okoli točke $A'$, da se točka $B''$ preslika na premico $a$. To storimo preko simetrale kota med daljico $A'B''$ in premico $a$ (operacija~\ref{op:O4}) ter konstrukcije pravokotnice na to simetralo skozi točko $B''$ (t.\ j.\ zrcaljenje točke $B''$ čeznjo, slika~\ref{fig:prenos_razdalje_koraki} desno). S tem dobimo točko $B'$, ki je po konstrukciji od točke $A'$ oddaljena za dolžino $r$.
    \end{enumerate}
