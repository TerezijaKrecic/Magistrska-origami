...
\end{aksiom}
\opomba{Če sta premici vzporedni, je tak pregib en sam, sicer pa sta pregiba dva (gl.\ sliko~\ref{fig:O3}).}
...
\end{aksiom}
\opomba{V poglavju~\ref{pogl:stoznice} bomo premislili, da s tem aksiomom konstruiramo ravno tangento na parabolo z goriščem v točki $A$ ter s premico vodnico $a$. V primeru, da je razdalja med točkama $A$ in $B$ večja od razdalje točke $B$ do premice $a$, dobimo dva možna pregiba, če sta razdalji enaki, je pregib en sam, v primeru manjše razdalje med točkama pa pregib ne obstaja. Na sliki~\ref{fig:O5} so prikazani vsi trije primeri.}
