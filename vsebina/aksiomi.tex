...
Do tega zaključka lahko pridemo tudi intuitivno. Operacija~\ref{op:O1} simulira uporabo neoznačenega ravnila, konstrukcija v operaciji~\ref{op:O6} podaja točke, ki so enako oddaljene od nekega središča, kar je ravno delo šestila.
