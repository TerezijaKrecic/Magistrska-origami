...
\begin{definicija}
    ...
    \emph{Origami konstrukcije} so konstrukcije točk in premic, ki jih je iz danih točk in razdalj mogoče konstruirati le z ravnimi in enkratnimi prepogibi iz operacij~\ref{op:O1}--\ref{op:O8}. Pri tem premico predstavlja pregib, novo točko pa določimo s presečiščem dveh pregibov.
\end{definicija}
