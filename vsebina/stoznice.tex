...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{images/stožnice/folding_kroznica_1.png}
    \includegraphics[width=0.25\textwidth]{images/stožnice/folding_kroznica_2.png}
    \includegraphics[width=0.25\textwidth]{images/stožnice/folding_kroznica_3.png}
...
\begin{trditev}
    Konstrukcija iz zgornje aktivnosti nam poda pregib, ki je tangenten na parabolo z goriščem v izbrani točki in premico vodnico, ki jo predstavlja spodnja stranica lista.
\end{trditev}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{images/stožnice/enacba_parabole1.png}
...
\begin{equation}
    ...
    y = \frac{x^2}{4c},
\end{equation}
torej je ovojnica res parabola. % Preden gremo na naslednji način dokaza, si poglejmo še vpliv parametra $c$ na parabolo. Razdalja med njenim goriščem in premico vodnico je $2c$ in iz enačbe~\eqref{eq:parabola_splosna} je razvidno, da bo z manjšanjem $c$ parabola vedno ožja.
...
\begin{dokaz}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.35\textwidth]{images/stožnice/elipsa_dokaz1.png}
        \includegraphics[width=0.35\textwidth]{images/stožnice/elipsa_dokaz2.png}
