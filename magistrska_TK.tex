...
\kljucnebesede{prepogibanje papirja\sep origami operacije\sep Belochin pregib\sep origami konstrukcije\sep origami števila\sep Hagovi izreki\sep \sep trisekcija kota\sep podvojitev kocke\sep prepogibanje tangent na stožnice\sep Lillova metoda\sep reševanje enačb\sep dualne stožnice\sep Alhazenov problem}

% - angleški prevod ključnih besed
\keywords{paper folding\sep origami operations\sep Beloch's fold\sep origami constructions\sep origami numbers\sep Haga's theorems\sep \sep angle trisection\sep doubling the cube\sep folding tangents to conics\sep Lill's method\sep equation solving\sep dual conics\sep Alhazen's problem}
