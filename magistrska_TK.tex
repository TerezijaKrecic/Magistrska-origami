...
\keywords{paper folding\sep origami operations\sep Beloch's fold\sep origami constructions\sep origami numbers\sep Haga's theorems\sep \sep angle trisection\sep doubling the cube\sep folding tangents to conics\sep Lill's method\sep equation solving enačb\sep dual conics\sep Alhazen's problem}
